...
float StepperMotorPosition3 = 0.0;
float StepperMotorPosition4 = 0.0;
float StepperMotorSpeed1 = 0.0;
float StepperMotorSpeed2 = 0.0;
float StepperMotorSpeed3 = 0.0;
float StepperMotorSpeed4 = 0.0;

float DesiredStepperMotorPosition1 = 0.0;
float DesiredStepperMotorPosition2 = 0.0;
float DesiredStepperMotorPosition3 = 0.0;
float DesiredStepperMotorPosition4 = 0.0;
...
void F_CheckSerialProtocol()
{
          ...
          {
            StrStepperMotorPosition3 = ReceivedChars;
            StrStepperMotorPosition3.remove(0,2);
            StepperMotorPosition3 = StrStepperMotorPosition3.toInt();
            MotorPositionCondition3 = true;
          }
          else if (ReceivedChars[0] == 'S' && ReceivedChars[1] == '3')
          {
            StrStepperMotorSpeed2 = ReceivedChars;
            StrStepperMotorSpeed2.remove(0,2);
            StepperMotorSpeed3 = StrStepperMotorSpeed3.toInt();
            MotorSpeedCondition3 = true;
          }
          else if (ReceivedChars[0] == 'P' && ReceivedChars[1] == '4')
          {
            StrStepperMotorPosition4 = ReceivedChars;
            StrStepperMotorPosition4.remove(0,2);
            StepperMotorPosition4 = StrStepperMotorPosition4.toInt();
            MotorPositionCondition4 = true;
          }
          else if (ReceivedChars[0] == 'S' && ReceivedChars[1] == '4')
          {
            StrStepperMotorSpeed4 = ReceivedChars;
            StrStepperMotorSpeed4.remove(0,2);
            StepperMotorSpeed4 = StrStepperMotorSpeed4.toInt();
            MotorSpeedCondition4 = true;
          }
}
...
void F_RunStepperMotorMotion()
{
  if (MotorPositionCondition1 == true && MotorSpeedCondition1 == true && MotorPositionCondition2 == true && MotorSpeedCondition2 == true)
    {
          stepper1.setSpeed(StepperMotorSpeed1);
          stepper2.setSpeed(StepperMotorSpeed2);
      if (StepperMotorPosition1 < CurrentEncoderPosition1)
        {
          stepper1.setSpeed(-StepperMotorSpeed1);
        }
      if (StepperMotorPosition2 < CurrentEncoderPosition2)
        {
          stepper2.setSpeed(-StepperMotorSpeed2);
        }  
      while (CurrentEncoderPosition1 != StepperMotorPosition1 || CurrentEncoderPosition2 != StepperMotorPosition2)
        {
          F_ReadEncoderPosition(); // Reads the encoder positions and prints them to serial monitor
          stepper1.runSpeed(); 
          stepper2.runSpeed();
        }

...
#define stepper3_dir_pin 25
#define stepper3_step_pin 24
  ...
  if (MotorPositionCondition1 == true && MotorSpeedCondition1 == true && MotorPositionCondition2 == true && MotorSpeedCondition2 == true)
    {
      ...
      stepper3.setMaxSpeed(StepperMotorSpeed3);
      stepper2.moveTo(StepperMotorPosition3);
      ...
      MotorPositionCondition3 = false;
      MotorSpeedCondition3 = false;
    }
}

...
def run():
    ...
    x = b'C,' + InputTheta1 + b',' + InputSpeed1 + b','+ InputTheta2 + b',' + InputSpeed2 + b','
    ser.write(x)
...
#------------------------------------------------------------------ Stepper Motor 1 ----------------------------------------------------------
root.update()
run_button1 = tk.Button(root, text ="Run", command=run)
run_button1.grid(row=0, column=0) 

theta_label1=tk.Label(root, text = "Position1 (angle): ")
theta_label1.grid(row=0,column=2)

theta_entry1=tk.Entry(root, bd=1,)
theta_entry1.grid(row=0,column=3)

speednote_label1=tk.Label(root, text = "(Note: dont exceed 200 steps/sec!)")
speednote_label1.grid(row=1,column=1)

speed_label1=tk.Label(root, text = "Speed (steps/sec): ")
speed_label1.grid(row=1,column=2)

speed_entry1 = tk.Entry(root, bd=1,)
speed_entry1.grid(row=1,column=3)

encoder_label1=tk.Label(root, text = "Encoder1 Feedback: ")
encoder_label1.grid(row=2,column=2)
